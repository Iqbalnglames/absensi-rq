...
@section('content')
    <div class="max-w-3xl mx-auto">
        ...
        <h1 class="text-2xl font-bold mb-6">Tambah Jadwal Mengajar</h1>
        ...
        <form action="{{ route('kurikulum.jadwal.store') }}" method="POST" class="bg-white shadow rounded-xl p-6 space-y-4">
            @csrf
            ...
            <div>
                ...
                <select name="user_id" id="guruSelect" class="w-full border rounded-lg px-3 py-2" required>
