...
@section('content')
    <div class="max-w-3xl mx-auto">
        ...
        <form action="{{ route('kesantrian.perizinan.store') }}" method="POST"
            ...
            <div>
                ...
                <input name="tanggal" type="date" class="w-full border rounded-lg px-3 py-2" required>
            </div>

            <div>
                <label class="block text-sm font-medium mb-1">Waktu mulai izin</label>
                <input name="waktu_mulai_izin" type="time" class="w-full border rounded-lg px-3 py-2" required>
            </div>

            <div>
                <label class="block text-sm font-medium mb-1">Waktu selesai izin</label>
                <input name="waktu_selesai_izin" type="time" class="w-full border rounded-lg px-3 py-2" required>
            </div>
