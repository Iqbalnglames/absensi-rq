...
@section('content')
    <div class="max-w-3xl mx-auto">
        ...
        <form action="{{ route('kesantrian.ekskul.store') }}" method="POST" class="bg-white shadow rounded-xl p-6 space-y-4">
            @csrf

            <div>
                <label class="block text-sm font-medium mb-1">Nama Ekskul</label>
                <input type="text" class="w-full border rounded-lg px-3 py-2" name="nama_ekskul">
            </div>
