...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <!-- tampilkan qr -->
        <a href="{{ route('kepegawaian.qr-absen') }}" class="bg-white p-6 rounded-xl shadow hover:shadow-lg transition">
        ...
        <!-- Kelola Absen -->
        <a href="{{ route('kepegawaian.absen') }}" class="bg-white p-6 rounded-xl shadow hover:shadow-lg transition">
            <div class="text-blue-500 text-3xl mb-3">👤</div>
        ...
        <!-- Kelola User -->
        <a href="{{ route('kepegawaian.users.index') }}" class="bg-white p-6 rounded-xl shadow hover:shadow-lg transition">
            <div class="text-blue-500 text-3xl mb-3">👤</div>
        ...
        <!-- Jadwal Kerja -->
        <a href="{{ route('kepegawaian.jadwal') }}" class="bg-white p-6 rounded-xl shadow hover:shadow-lg transition">
        ...
        <!-- Izin -->
        <a href="{{ route('kepegawaian.izin') }}" class="bg-white p-6 rounded-xl shadow hover:shadow-lg transition">
